...
\begin{frame}
    ...
    \end{itemize}
    \onslide<9->{\arrow Result: 90\% accuracy on validation set in 50 epochs / $\approx$ 7 mins. of training}

    \vspace{1em}
    \onslide<10->{Source code: \url{https://github.com/philipobi/seminar}}
\end{frame}
