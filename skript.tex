...
\begin{flalign*}
    ...
    & J(x_1, \ldots, x_m; \theta) = \frac{1}{m} \sum_{i=1}^{m} L()&&\\
\end{flalign*}

\subsection{Stochastic Gradient Descent}
Mostly our cost function will depend on examples, e.g. const function defined by ML-Estimator: $J(x_1, \ldots, x_m; \theta)$ \\
To minimize cost function we usually use some form of gradient descent, simplest form:
\begin{flalign*}
    \theta_{k+1} \, \leftarrow \, \theta_k - \epsilon \nabla_\theta J(x_1, \ldots, x_m; \theta)
\end{flalign*}
